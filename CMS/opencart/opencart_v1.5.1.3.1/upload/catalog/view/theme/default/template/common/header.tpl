...
<div id="header">
  ...
  <div id="telephone">
  <?php echo $text_telephone; echo $telephone;echo $phone; ?>
  </div>
  ...
  <div id="cart">
    <div class="heading">
      <h4><a href="<?php echo $cart; ?>"><div id="shopping_cart"><?php echo $text_cart;  ?></div></h4>
  ...
  <div class="links"><a href="<?php echo $home; ?>"><?php echo $text_home; ?></a><a href="<?php echo $wishlist; ?>" id="wishlist_total"><?php echo $text_wishlist; ?></a><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a><a href="<?php echo $cart; ?>"><div id="shopping_cart"><?php echo $text_cart; ?></div></a><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></div>
</div>
<?php if ($categories) { ?>
<div id="menu">
  <ul>
