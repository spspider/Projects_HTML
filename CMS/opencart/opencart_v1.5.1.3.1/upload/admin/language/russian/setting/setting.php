...
$_['entry_tax_default']        		= 'Адрес магазина для расчета налогов:<br /><span class="help">Используемый адрес магазина для расчета налогов, если никто не зарегистрирован в системе. Вы можете выбрать для использования адрес в магазине для клиентов, соответствующий адресам отгрузки и оплаты.</span>';
$_['entry_tax_customer']       		= 'Адрес магазина для клиентов при расчете налогов:<br /><span class="help">Используемый адрес для авторизированных клиентов магазина при расчете налогов. Вы можете использовать адрес по умолчанию для клиентов, соответствующий адресам отгрузки и оплаты.</span>';
