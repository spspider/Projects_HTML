...
$_['entry_tax']					= 'Отображать цены с налогом:';
$_['entry_tax_default']         = 'Адрес магазина для расчета налогов:<br /><span class="help">Использовать адрес магазина для расчета налогов, если никто не зарегистрирован в системе. Вы можете выбрать для использования адрес в магазине для клиентов, соответствующий адресам отгрузки и оплаты.</span>';
