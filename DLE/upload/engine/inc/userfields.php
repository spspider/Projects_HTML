...
<table width="100%">
	...
	<tr id="select_options">
        ...
        <td><textarea style="width: 320px; height: 100px;" name="editedxfield[6_select]"><?php echo ($editedxfield[3] == "select") ? $editedxfield[6] : ""; ?></textarea><br>на одной строке одно значение</td>
    </tr>
    <tr>
